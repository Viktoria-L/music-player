...
const Controls = ({ audioRef, progressBarRef, tracks, mini }) => {
    ...
    return (
        <div className={`controlwrapper flex flex-col justify-center gap-4 w-full ${mini}`}>
            <div className={`controls text-center ${mini}`}>
                <button onClick={()=>{dispatch(handlePrevious())}} className='miniBtn'>
                    <IoPlaySkipBack />
                </button>
                ...
                <button onClick={()=>{dispatch(handleNext())}} className='miniBtn'>
                    <IoPlaySkipForward />
                </button>
